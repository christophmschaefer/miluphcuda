...
# scalar floats only 
#wanted_attributes = ['rho', 'p', 'sml', 'e', 'material_type', 'number_of_interactions', 'alpha_jutzi', 'DIM_root_of_damage','soundspeed', 'local_strain', 'ddamage_porjutzidt', 'DIM_root_of_damage_porjutzi' ]
#wanted_attributes = ['rho', 'p', 'sml', 'e', 'material_type', 'number_of_interactions', 'alpha_jutzi' ]
wanted_attributes = ['DIM_root_of_damage_tensile' , 'local_strain' ,'m' ,'material_type' ,'number_of_activated_flaws' ,'number_of_interactions' ,'p' ,'rho' ,'sml' ,'soundspeed' ,'tree_depth' ]
...
for hfile in args.input_files:
    ...
    for myattr in wanted_attributes:
        datatype = "Float"
        if myattr in ['number_of_interactions', 'material_type', 'number_of_activated_flaws', 'tree_depth']:
            datatype = "Integer"
