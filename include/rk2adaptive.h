 ...
 */
#define RK2_USE_VELOCITY_ERROR 1
#define RK2_USE_DENSITY_ERROR 1
#define RK2_USE_ENERGY_ERROR 1
...
#define RK2_LIMIT_ALPHA_CHANGE 0   // special check for PALPHA_POROSITY for crush curve convergence
